...
def process_slack_to_whatsapp(event, bot_token):
    ...
    try:
        ...
        if "files" in event and event["files"]:
            ...
            for file_info in event["files"]:
                try:
                    ...
                    # Pre-emptive validation of file size
                    ...
                    # Logic to send caption only with the first file
        ...
        # --- Case 2: The message is text-only (with mention support) ---
        else:
            ...
            # Send to WhatsApp with mentions
